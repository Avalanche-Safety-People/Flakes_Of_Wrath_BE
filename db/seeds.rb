...
bob = User.create!(uid: "123", provider: "google", name: "bob", email: "bob@gmail.com", favorite_zone: 88)
sally = User.create!(uid: "123", provider: "google", name: "sally", email: "sally@gmail.com", favorite_zone: 4)
